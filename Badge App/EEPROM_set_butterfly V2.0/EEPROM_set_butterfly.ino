...
#define Butterfly_ID  0x00123457
/*
...
*/
#define Colour1 0x00217074
#define Colour2 0x0037745B
#define Colour3 0x008B9D77
#define Colour4 0x00E7EAEF
#define Colour5 0x00EDC5AB
...
char b = '0';
char c = '0';
if(data_buffer[0] == 0x12)  a = 'A';
if(data_buffer[1] == 0x34)  b = 'B';
if(data_buffer[2] == 0x56)  c = 'C';
Serial.println(a);
Serial.println(b);
Serial.println(c);
